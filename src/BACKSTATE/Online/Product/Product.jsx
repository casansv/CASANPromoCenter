...
export default function ProductPage() {
    ...
    useEffect(() => {
        // Código dependiente de `window` que solo se ejecuta en el cliente
                ...
                <div>
                    ...
                    <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                        ...
                        <p className="text-lime-400 text-xs mb-6">
                            *Este precio no incluye los costos de importación. Estos se añadirán y mostrarán en el coste final de la compra.
                        </p>
