...
const product = {
    ...
    "review": "El juego de funda de edredón CGK Unlimited combina lujo, comodidad y practicidad. Ideal para quienes valoran la calidad sin comprometer el presupuesto, este juego ofrece una sensación de suavidad extraordinaria y una durabilidad superior. Su diseño ligero y transpirable asegura un sueño reparador en cualquier temporada, mientras que su fácil cuidado lo hace perfecto para hogares ocupados. Es la elección ideal para transformar tu dormitorio en un espacio elegante y acogedor.",
    "features": [
        "Suavidad excepcional: Microfibra de doble cepillado que proporciona una textura lujosa y cómoda.",
        "Duradero y vibrante: Tratamiento de retención de color que evita la decoloración para mantener los colores frescos.",
        "Fácil mantenimiento: Cierre de cremallera oculto y 8 lazos que aseguran un ajuste cómodo y sin esfuerzo.",
        "Diseño ligero y transpirable: Ideal para un descanso fresco durante todo el año.",
        "Juego completo King: Incluye una funda de edredón (104x90 pulgadas) y dos fundas de almohada (20x36 pulgadas)."
    ],
    "images": [
        "https://m.media-amazon.com/images/I/81r4PlsVxmL._AC_SX522_.jpg",
        "https://m.media-amazon.com/images/I/71WB4uM7n0L._AC_SX522_.jpg",
        "https://m.media-amazon.com/images/I/71F3m1wrTGL._AC_SX522_.jpg"
    ],
    "link": "https://amzn.to/3VF8Fe7"
};
