...
const product = {
    ...
    "review": "La Samsung Chromebook Plus es una herramienta confiable y versátil que se adapta a todas tus necesidades. Ideal para estudiantes que requieren portabilidad y eficiencia, y para profesionales que buscan un equipo ligero y funcional. Su pantalla táctil, gráficos vibrantes y conectividad avanzada, incluyendo WiFi 5 y Bluetooth, hacen de este dispositivo una solución completa para trabajar, estudiar y disfrutar de contenido multimedia. Además, cuenta con accesorios adicionales como un lápiz capacitivo y un mouse inalámbrico, mejorando tu experiencia de usuario.",
    "features": [
        "Pantalla táctil versátil: FHD de 12.2 pulgadas con bisagra de 360° para usar como laptop o tableta.",
        "Almacenamiento ampliable: 64GB eMMC con expansión hasta 224GB, espacio suficiente para aplicaciones y multimedia.",
        "Procesador eficiente: Intel Celeron 3965Y de doble núcleo, perfecto para multitareas ligeras y navegación fluida.",
        "Conectividad avanzada: WiFi 802.11ac, Bluetooth 5.2, USB-C y USB 3.0 para máxima compatibilidad.",
        "Chrome OS integrado: Rápido, seguro y actualizado, con miles de aplicaciones y copias de seguridad en la nube."
    ],
    "images": [
        "https://m.media-amazon.com/images/I/81k+w98hRSL._AC_SX425_.jpg",
        "https://m.media-amazon.com/images/I/81JV5+KovwL._AC_SY355_.jpg",
        "https://m.media-amazon.com/images/I/71YPut73f7L._AC_SY355_.jpg"
    ],
    "link": "https://amzn.to/3CRaDRW"
};
