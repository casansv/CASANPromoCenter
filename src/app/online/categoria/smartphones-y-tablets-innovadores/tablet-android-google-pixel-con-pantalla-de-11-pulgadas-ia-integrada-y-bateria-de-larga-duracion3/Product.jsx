...
const product = {
    ...
    "review": "La Google Pixel Tablet es perfecta para quienes buscan un dispositivo versátil, potente y fácil de usar. Su diseño moderno y la incorporación de herramientas como Google Meet para videollamadas en HD te harán sentir conectado en cualquier lugar. Es ideal tanto para profesionales que necesitan una herramienta eficiente como para familias que disfrutan de entretenimiento en streaming. Una tablet que combina funcionalidad y estilo para adaptarse a tu estilo de vida.",
    "features": [
        "Procesador Tensor G2 integrado: Disfruta de un rendimiento superior y herramientas potenciadas por IA.",
        "Pantalla de 11 pulgadas: Colores vibrantes y brillo adaptable para una experiencia visual inigualable.",
        "Batería de larga duración: Hasta 12 horas de uso continuo para trabajar o entretenerte sin preocupaciones.",
        "Transferencia rápida y segura: Comparte contenido fácilmente entre dispositivos Pixel con Quick Share.",
        "Diseño versátil y ampliable: Compatible con accesorios como teclado, lápiz y base de carga con altavoz."
    ],
    "images": [
        "https://m.media-amazon.com/images/I/71yATvhR3OL._AC_SX569_.jpg",
        "https://m.media-amazon.com/images/I/51HH7hny7lL._AC_SX425_.jpg",
        "https://m.media-amazon.com/images/I/514gxC13vdL._AC_SX425_.jpg"
    ],
    "link": "https://amzn.to/4icDiBe"
};
