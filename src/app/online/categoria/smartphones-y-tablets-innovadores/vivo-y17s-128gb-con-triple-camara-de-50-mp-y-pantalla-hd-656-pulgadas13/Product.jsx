...
const product = {
    ...
    "review": "El vivo Y17s es perfecto para quienes buscan un smartphone confiable y versátil. Su triple cámara captura imágenes excepcionales, mientras que su pantalla de alto brillo y batería de larga duración ofrecen entretenimiento sin interrupciones. Con un diseño moderno y resistencia certificada, este dispositivo combina funcionalidad, estilo y durabilidad para satisfacer las necesidades de usuarios dinámicos.",
    "features": [
        "Triple Cámara de 50 MP: Fotos de alta calidad con cámara principal, bokeh y macro.",
        "Pantalla HD+ de 6,56 pulgadas: Brillo mejorado y colores vibrantes para una experiencia visual envolvente.",
        "Batería de 5000 mAh: Hasta 60 horas de música o 20 horas de videos con carga rápida de 15W.",
        "Diseño resistente y elegante: Acabado 2.5D, lector lateral de huellas y certificación IP54 contra agua y polvo.",
        "Rendimiento eficiente: 4GB de RAM con expansión de hasta 7GB y 128GB de almacenamiento interno."
    ],
    "images": [
